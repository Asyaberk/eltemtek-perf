...
export class UsersService {
    ...
    async create(dto: CreateUserDto): Promise<User> {
        ...
        const office = dto.office_id ? await this.officeRepo.findOneByOrFail({ id: dto.office_id }) : undefined;
        const tesis = dto.tesis_id ? await this.tesisRepo.findOneByOrFail({ id: dto.tesis_id }) : undefined;
        const seflik = dto.seflik_id ? await this.seflikRepo.findOneByOrFail({ id: dto.seflik_id }) : undefined;
        const mudurluk = dto.mudurluk_id ? await this.mudRepo.findOneByOrFail({ id: dto.mudurluk_id }) : undefined;
